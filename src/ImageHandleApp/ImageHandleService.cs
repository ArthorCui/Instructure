    ...
    public class ImageHandleService
    {
        ...
        public void Handle()
        {
            ...
            foreach (var item in originFileList)
            {
                ...
                if (item.Length > 0)
                {
                    SingalHandle(originFileUrl, targetFileUrl, count);
                    count++;
                }
            }
            Console.ReadLine();
        ...
        public void SingalHandle(string input, string output, int count)
        {
            ...
            if (mg != null)
            {
                ...
                {
                    CutForSquare(count, input, output);
                }
            }
        }

        public void CutForSquare(int count, string fileFormUrl, string fileSaveUrl, int side = 72, int quality = 100)
        {
